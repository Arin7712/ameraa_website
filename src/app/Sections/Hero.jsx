...
export default function Hero() {
    return (
      <div className="relative mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 max-sm:pt-10 pb-40 max-sm:pb-10 bg-[url('/money21.png')] max-sm:bg-[url('/money22.png')] bg-cover max-sm:bg-[center_top_-100px] bg-[center_top_-240px] bg-no-repeat">
