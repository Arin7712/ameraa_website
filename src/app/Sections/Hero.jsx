...
export default function Hero() {
    return (
      <div className="relative mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 max-sm:pt-10 pb-40 max-sm:pb-10 bg-[url('/money21.png')] max-sm:bg-[url('/money22.png')] bg-cover max-sm:bg-[center_bottom] sm:bg-[center_top_-240px] bg-no-repeat">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-8 mb-14 max-sm:text-sm max-w-[700px] text-[#003E47]">Get ₹10Cr+ project funding from banks and investors. We arrange LCs & BGs for ₹10Cr+ import-export deals and ₹1Cr+ without property via international banks. Based in Lucknow, serving PAN India</p>
