          ...
          {[
            ...
            >
              <div className="bg-white rounded-lg p-6 shadow-lg border-t-4 border-yellow-400">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-yellow-400 rounded-full w-8 h-8 flex items-center justify-center text-neutral-900 font-bold">
                  {item.step}
                </div>
                <div className="mt-4">
              ...
              {index < 3 && (
                <div className="hidden md:block absolute top-1/2 left-full w-full h-0.5 bg-yellow-400 -translate-y-1/2"></div>
              )}
            </div>
          ))}
        </div>

        <div className="mt-16 bg-neutral-900 rounded-lg p-8 animate__animated animate__fadeIn">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <a
                href="#contact"
                className="inline-block bg-yellow-400 text-neutral-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition-colors duration-300"
              >
                Contact Now
              </a>
            </div>
